$(document).ready(function(){
  ...
  //       if((theme.length < 3) || (theme.length >20))
    ...
    //even date must be greate then to from date
    $("#txt_date_event").focus(function(){
        var txt_from= $("#txt_from").val();
        $("#txt_date_event").attr('min',txt_from);
    });
   ...
   //new rob form start
    ...
    //     txt_to_err=true; //to
    //     txt_aud_size_err=true;  //for approx size
    ...
    //     check_txt_from(); //from
    //     check_txt_to();  //to
    //     check_txt_aud_size(); //for approx size
    ...
    //     if((txt_sop_theme_err==true) && (txt_no_covered_err==true) && (txt_vilage_name_err==true) && (txt_from_err==true) && (txt_to_err==true) && (txt_aud_size_err==true) && (ddl_pro_activity_err==true) && (ddl_off_type_err==true) && (ddl_area_nature_err==true) && (ddl_area_act_err==true))
    //     {
    ...
    // });
        ...
        function printErrorMsg (msg) {
            console.log(msg);
            $("#document_type_err,#event_date_err,#venue_event_err,#detail_report_err,#video_err,#video_caption_err,#video2_err,#video2_caption_err,#video3_err,#video3_caption_err").show();



            $("#document_type_err").html(msg[0]);
            $("#event_date_err").html(msg[1]);
            $("#venue_event_err").html(msg[2]);
            $("#detail_report_err").html(msg[3]);
            $("#video_err").html(msg[4]);

            $("#video_caption_err").html(msg[5]);
            $("#video2_err").html(msg[6]);
            $("#video2_caption_err").html(msg[7]);
            $("#video3_err").html(msg[8]);
            $("#video3_caption_err").html(msg[9]);
...
// $(".mouse").unbind("click");
// document.getElementsByClassName('mouse').style.pointerEvents = 'none';
...
$(document).ready(function () {
  ...
  $(".custom-file-input").change(function () {
    ...
    if(!approve.includes(ext))
    {
        ...
        $("#" + id + 2).text("Choose file");
        $("#" + id + 3).html("Upload").addClass("input-group-text");
        $("#" + id + 1).text('Accept only jpg/png/gif formate!');
        $("#" + id + 1).show();
        $("#" + id + "-error").addClass("hide-msg");
        return false;
    }
