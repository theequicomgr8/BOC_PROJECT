document.addEventListener('DOMContentLoaded', function(){
	(function(){
		...
		var options = {
			googleCloudAPIKey: 'AIzaSyAgvvPpyxo3IjhB-CMG7wCgCHcYvV7FJxU',
		...
		var initAutocomplete = function(){
			...
			//if you want to search all world location then remove down code
