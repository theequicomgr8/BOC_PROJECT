$(document).ready(function(){
    $("#ddl_off_type2").change(function(){
        var off_type_value=$('#ddl_off_type2').val();
        
        $.ajax({
            type: 'GET',
            url: '/adg_hqregion',
            data:{office_type:off_type_value},
        ...
        // {
        //     //alert(off_type_value);
        //     $.ajax({
        //         type: 'GET',
        //         url: 'adgforegion',
        //         data:{off_type_value:off_type_value},
        //         success:function(data)
        //         {
