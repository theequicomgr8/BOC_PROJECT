          ...
          <div id="logins-part" class="content pt-3" role="tabpanel" aria-labelledby="logins-part-trigger">
            ...
            <div class="col-xl-4">
              <div class="form-group">
                ...
                <input type="text" name="distance_covered" value="{{@$data->distance_covered ?? ''}}" id="distance_covered" onkeypress="return onlyNumberKey(event);" placeholder="Enter Distance" class="form-control form-control-sm" readonly max="5">
