...
<div class="content-inside p-3">
  <div class="card shadow mb-4">
    ...
    <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
      ...
      <h6 class="m-0 text-primary"><a href="{{url('pre-form-pdf/'.@$data->Pk_id)}}" style="display: {{$download_dispaly;}}"><i class="fa fa-edit"></i> TTP reciept download</a></h6>
      {{-- <h6 class="m-0 text-primary"><a href="{{url('post_form_pdf/'.@$data->Pk_id)}}"><i class="fa fa-edit"></i> Download</a></h6> --}}
    </div>
    <!-- Card Body -->
    <div class="row">
        <div class="col-xl-12">
