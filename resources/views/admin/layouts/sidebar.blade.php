<nav id="sidebar">
  <div class="sidebar-header">
    ...
    <h3 class="inside-logo">
      <img class="logo" style=' {{ strlen(Session::get('HeadName')) >27 ? "vertical-align: bottom ": "vertical-align: middle"}}' src="{{asset('theme/images/logo-s.png')}}" /> <span class="mt-3">@if(Session::has('HeadName'))
        ...
        @endif
        <?php 
        // @if(Session::get('UserType')==2 || Session::get('UserType')==3 || Session::get('UserType')==5)
        //         <p style="font-size: 15px;">{{Session::get('UserName')}}</p>
        // @endif
        ?>
        @if(Session::get('UserType')==2)
          @php 
          $name=substr(Session::get('UserName'),4,50);
          @endphp
          {{"RO-".$name}}
        @endif
        @if(Session::get('UserType')==3)
          ...
          {{"FO-".$name}}
        @endif
        @if(Session::get('UserType')==1 && (Session::get('WingType') ==0))
          <p class="pl-3" style="font-size: 12px;">{{Session::get('CompanyName')}} <br/>
            Agency Code : {{Session::get('UserID')}}</p>
        @endif
        @if( (Session::get('UserType')==1) && (Session::get('WingType') ==3) )
          @if(Session::get('NewspaperName') != '' || Session::get('NewspaperName') != NULL)
                  <p class="pl-3" style="font-size: 12px;">{{Session::get('NewspaperName')}} ({{Session::get('PlacePublication')}})
                  <br/> <small> NP Code : {{Session::get('UserName')}}</small></p>
          @endif
        @endif
      </span>
  ...
  <div class="p-3">
    ...
    @if(Session::get('UserType')==0)
      @if(Session::get('profile_name')=='' && Session::get('profile_address')=='' && Session::get('profile_designation')=='' && Session::get('email')=='' && Session::get('Mobile')=='')
        <a href="{{url('client-profile')}}"><i class="fa fa-fw fa-home"></i>Dashboard</a>
      @else
    ...
    @else
      ...
      <?php
        ...
        {
          $wing_type_name = '- AV-Producer';
          $wing_name = 'AV-Producer';
        }
    ...
    <ul class="list-unstyled components mb-5">
      ...
      <li><a href="{{ url('client-pending-creative-list') }}"> Pending Creative</a></li>
      ...
      <!-- <li>
        ...
        <li>
          <a href="{{ url('rob-banner') }}" class="nav-link">
            <i class="fa fa-angellist" aria-hidden="true"></i>
            Banner Image
          </a>
        </li>
        <li>
          <a href="{{ url('whats-new') }}" class="nav-link">
            <i class="fa fa-angellist" aria-hidden="true"></i>
            What's New
          </a>
        </li>
        <li>
        <a href="{{ url('approvelist') }}" class="nav-link">
          <i class="fa fa-angellist" aria-hidden="true"></i>
          Approve List
        </a>
      </li>
      ...
      <li>
        ...
        <!-- Soleright linking -->
        <a href="#solerightEmpanelment" data-toggle="collapse" aria-expanded="false" class="dropdown-toggle"> <i class="fa fa-photo"></i> Outdoor</a>

        <ul class="collapse list-unstyled" id="solerightEmpanelment">
          <li>
            <a href="{{ url('outdoor-media-list') }}"><i class="fa fa-print"></i> Fresh Empanelment</a>
          </li>

          <li>
            <a href="{{ url('outdoor-media-list') }}"><i class="fa fa-edit"></i> Renewal</a>
          </li>
         ...
         <li>
          ...
          <li>
            <a href="{{ url('outdoor-media-list') }}"><i class="fa fa-upload"></i> Agreement of Fresh Empanelment</a>
          </li>
          <!-- <li>
        ...
        <ul class="collapse list-unstyled" id="printEmpanelment">
          ...
          @else
          <li>
            <a href="#"><i class="fa fa-edit"></i> Renewal</a>
          </li>
         @endif
         <li>
        ...
        @elseif(Session::get('WingType')==4)
          ...
          <ul class="collapse list-unstyled" id="av_tvEmpanelment">
            ...
            <li>
                <a href="{{ url('ro-list') }}"><i class="fa fa-angellist" aria-hidden="true"></i> RO List</a>
            </li>
            <li>
          ...
          <a href="#avproducersEmpanelment" data-toggle="collapse" aria-expanded="false" class="dropdown-toggle">AV Producer Management</a>
          ...
          <ul class="collapse list-unstyled" id="avproducersEmpanelment">
            ...
            <li>
              <a href="{{url('bulksms-agreement')}}"><i class="fa fa-upload"></i> Agreement of Fresh Empanelment</a>
            </li>
       ...
       <!--  @elseif(Session::get('WingType')==11)
        ...
        <li>
          <a href="{{ route('approved-list') }}"><i class="fa fa-solid fa-list"></i> Approved List</a>
        </li>
        @elseif(Session::get('WingType')==3)
         <li>
      ...
      <li>
        <a href="{{URL::to('client-profile')}}" >Client Profile</a>
      </li>
      @endif
      @if(Session::get('UserType')==1)
      <li>
    ...
    @endif
      ...
      @if( (Session::get('UserType')==1)  ) 
        ...
        @if(Session::get('WingType') != 0 || Session::get('WingType') != 1 || Session::get('WingType') != 2 ) 
        <li>
            <a href="#advisories_empaneled" data-toggle="collapse" aria-expanded="false" class="dropdown-toggle"> <i class="fa fa-list"></i> Empaneled Vendors</a>
            <ul class="collapse list-unstyled" id="advisories_empaneled">
              ...
              <li>
              <a href="{{URL::to('tv-channel-code-list')}}"> TV Channels</a>
      ...
      @if(Session::get('UserType')==0)
      <li>
        <a href="{{URL::to('uploads/footer_document/ClientFAQs.pdf')}}" ><i class="fa fa-gear"> </i> FAQs</a>
      </li>
      @elseif(Session::get('UserType')==1)
        @if(Session::get('WingType') == 0)
          <li>
            <a href="{{URL::to('uploads/footer_document/OutdoorFAQs.pdf')}}" target="_blank"> <i class="fa fa-gear"> </i> Vendor FAQs</a>
          </li>
          <li>
            <a href="{{URL::to('uploads/footer_document/User Manual for Outdoor Vendor Empanelment.pdf')}}" target="_blank"> <i class="fa fa-gear"> </i> User Manual</a>
          </li>
        @else
          <li>
            <a href="{{URL::to('uploads/footer_document/VendorFAQs.pdf')}}" target="_blank"> <i class="fa fa-gear"> </i> Vendor FAQs</a>
          </li>
        @endif
      @endif
