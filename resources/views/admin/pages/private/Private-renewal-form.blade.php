  ...
  <div class="content-inside p-3">
    <div class="card shadow mb-4">
      ...
      <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
        <h6 class="m-0 font-weight-normal text-primary">Private Fresh Empanelment Renewal</h6>
      </div>
      <!-- /.end card-header -->
      <form method="post" action="{{url('private-renewal')}}" autocomplete="off">
        {{ csrf_field() }}
          ...
          <div class="content pt-3 tab-pane active show" role="tabpanel">
            <div class="row" style="margin:0">
              ...
              <div class="col-md-4">
                ...
                <!-- If Record Not Found Then Show This Msg 3-Dec Suman -->
