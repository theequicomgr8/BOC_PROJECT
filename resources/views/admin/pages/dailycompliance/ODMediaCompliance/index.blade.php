...
<div class="content-inside p-3">
  <div class="card shadow mb-4">
    ...
    <div class="card-header py-3">
      <h6 class="m-0">
        <i class="fa fa-user"></i> Daily Compliance
         <a style="font-size: 14px;" class="m-0 text-primary float-right" href="{{route('ODMediaCompliance.create')}}"  id="addnew" /> 
        <i class="fa fa-user-plus"></i> Click to Add New Compliance </a>
      </h6> 
    </div>
    <!-- Card Body -->
    <div class="card-body">
        <div class="card-body p-2">
         <!--  <form name ="odmcsearch" id="odmcsearch" method="GET" enctype="multipart/form-data" action="{{Route('ODMediaCompliance.index')}}" >
            <div class="row">
              <div class="col-md-4">
