...
<div class="content-inside p-3">
    <div class="card shadow mb-4">
        <div class="card-header py-3">           
            ...
            <div class="row">
                <div class="col-xl-7">
                    <h5><i class="fa fa-list-ol" aria-hidden="true"></i> Approved List</h5>
                </div>
                <!-- <div class="col-xl-2">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                {{'Active'}}
                                @else
                                <a href="outdoor-media-renewal/{{ $vendors->media_id }}" class="text-info">Renewal </a>
                                @endif
                            </td>
                            @else
                            <td>
