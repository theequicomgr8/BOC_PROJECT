    ...
    <section class="content">
      ...
      <div class="card card-default">
        ...
        <div class="card-header">
              <h5 class="card-title font-weight-normal  text-primary">New Media Agreement</h5>
            ...
            <div class="col-md-2"></div>
              <div class="col-md-6">
                <div class="form-group">
                  <label for="publication">Internet Website Upload Agreement file /  इंटरनेट वेबसाइट अपलोड अनुबंध फ़ाइल<font color="red">*</font></label>
