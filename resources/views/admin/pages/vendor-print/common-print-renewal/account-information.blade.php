<div class="row">
  <div class="col-md-4"><br>
    <div class="form-group">
      <label for="account_type">Account Type / खाते का प्रकार</label>
      <select class="form-control  form-control-sm" name="account_type" id="account_type" {{$disabled}}>
         <option value="">Please Select</option>
        <option value="0" {{ (@$vendor_datas->{'Account Type'} == 0 && @$vendor_datas->{'Account Type'} != "" ? 'selected' : '') }}>Saving</option>
  ...
  <div class="col-md-4">
    <div class="form-group">
      <label for="bank_account_no">Bank Account Number for Receiving Payments / भुगतान प्राप्त करने के लिए बैंक खाता संख्या</label>
  ...
  <div class="col-md-4">
    <div class="form-group divmargin">
      <label for="account_holder_name">Account Holder Name / खाता धारक का नाम</label>
  ...
  <div class="col-md-4">
    <div class="form-group">
      <label for="bank_name">Bank Name / बैंक का नाम</label>
  ...
  <div class="col-md-4">
    <div class="form-group">
      <label for="ifsc_code">IFSC Code / आई एफ एस सी कोड</label>
  ...
  <div class="col-md-4">
    <div class="form-group">
      <label for="branch_name">Branch / शाखा</label>
  ...
  <div class="col-md-4">
    <div class="form-group">
      <label for="address_of_account">Address of Account / खाते का पता</label>
  ...
  <div class="col-md-4">
    <div class="form-group">
      <label for="pan_card">PAN Card No. / पैन कार्ड नंबर</label>
      <input type="text" name="pan_card" id="pan_card" class="form-control form-control-sm" maxlength="10" placeholder="Enter Pan Card No." value="{{ $vendor_datas->{'PAN'} ?? '' }}" {{ @$readonly }} onkeypress="javascript:return isAlphaNumeric(event,this.value);">
