    ...
    <section class="content">
      ...
      <div class="card card-default">
        ...
        <div class="card-header">
              <h5 class="card-title font-weight-normal  text-primary">Digital Cinema Agreement</h5>
              <h2 class="text-right" style="margin-top: -45px;">
                {{-- <a href="{{ url('solefile-download')}}" download class="btn btn-primary btn-sm">Export to PDF</a></h2> --}}
                @if($filebase_url == "")
          ...
          <form action="{{ route('personal.upload.post') }}" method="POST" enctype="multipart/form-data">
          @csrf
          <div class="card-body">
            <div class="row">
