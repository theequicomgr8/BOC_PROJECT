...
if(@$vendor_data[0]['Status'] != 6 && @$vendor_data[0]['Status'] != 0 && $media_id !='')
{
$disabled = 'disabled';
$readonly = 'readonly';
$checked = 'checked';
      ...
      <form method="POST" id="personal_media">
        ...
        <div class="tab-content">
            ...
            <div class="row" id="details_of_owners">
              ...
              <div class="col-md-4">
                <div class="form-group">
                  ...
                  <p>
                    <input type="email" class="form-control form-control-sm" id="owner_email0" name="owner_email[]" maxlength="50" placeholder="Enter Email ID" value="{{$ownerlist['Email ID']?? ''}}" onchange="return checkUniqueOwnerpersonalmedia(this, this.value,0)" readonly>
                    <span id="alert_owner_email0" style="color:red;display: none;"></span>
                  </p>
                </div>
              </div>
              ...
              <div class="col-md-4">
                <div class="form-group">
                  ...
                  <input type="text" name="owner_mobile[]" id="owner_mobile0" maxlength="10" placeholder="Enter Mobile" class="form-control form-control-sm input-imperial" onkeypress="return onlyNumberKey(event)" maxlength="10" value="{{$ownerlist['Mobile No_'] ?? ''}}" onchange="return checkUniqueOwnerpersonalmedia(this, this.value,0)" readonly>
          ...
          <div id="tab2" class="content pt-3 tab-pane" role="tabpanel" aria-labelledby="tab1-trigger">
            ...
            <div class="row">
              <div class="col-md-4">
                <div class="form-group">
                  ...
                  <input type="text" name="HO_Email" placeholder="Enter E-mail" class="form-control form-control-sm" id="email" value="{{$vendor_data[0]['HO E-Mail']??session('email')}}" maxlength="50" onchange="return checkUniqueVendor('email', this.value)" {{$disabled}}>
              ...
              <div class="col-md-4">
                <div class="form-group">
                  ...
                  <input type="text" class="form-control form-control-sm" id="mobile" name="HO_Mobile_No" placeholder="Enter Mobile" onkeypress="return onlyNumberKey(event)" maxlength="10" value="{{$vendor_data[0]['HO Mobile No_']??''}}" onchange="return checkUniqueVendor('mobile', this.value)" {{ @$readonly }}>
              ...
              <div class="row">
                ...
                <div class="col-md-4">
                  <div class="form-group">
                    ...
                    <input type="text" name="Other_Relevant_Information" placeholder="Enter Any Other Relevant Information" class="form-control form-control-sm" id="Other_Relevant_Information" value="{{$vendor_data[0]['Other Relevant Information']??''}}" onkeypress="return isAlphaNumericSpace(event)" {{$disabled}}>
            ...
            <div class="row">
              ...
              <div class="col-md-4">
                <div class="form-group">
                  ...
                  <input type="date" name="Media_Type" placeholder="DD/MM/YYYY" class="form-control form-control-sm" min="{{ date('Y-m-d',strtotime('-10 years')) }}" value="{{ (!empty($vendor_data[0]['Duration']) && @$vendor_data[0]['Duration'] != '1753-01-01 00:00:00.000') ? date('Y-m-d', strtotime(@$vendor_data[0]['Duration'])) : ''}}" {{$disabled}}>
                </div>
              </div>
              @php
            ...
            @php
            $arr =array(0=>'Airport', 1=>'Railway Station', 2=>'Road Side', 3=>'Moving Media', 4=>'Public Utility');
            @endphp
            <div class="row">
              <div class="col-md-4">
                <div class="form-group">
                  <label>Outdoor media format for which applying / बाहरी मीडिया प्रारूप जिसके लिए आवेदन किया जा रहा है</label>
                  <select name="Applying_For_OD_Media_Type" class="form-control form-control-sm media_sub_category" style="width: 100%;" {{$disabled}}>
              ...
              <div class="col-md-4"><br>
                <div class="form-group">
                  <label>Outdoor media Sub Category / आउटडोर मीडिया उप श्रेणी</label>
                  <select name="sub_category_outdoor" id="sub_category_outdoor" class="form-control form-control-sm" style="width: 100%;" {{$disabled}}>
                    <option value="">Select Sub Category </option>
                    @if(@$vendor_data[0]['Media Sub Category'] !='')
                    @foreach($mediaSubCatData as $key =>$mediaSubCat)
                    <option value="{{ $mediaSubCat->{'OD Media UID'} }}" @if(@$vendor_data[0]['Media Sub Category']==$mediaSubCat->{'OD Media UID'} ) selected="selected" @endif>{{ $mediaSubCat->{'Name'} }}</option>
                    @endforeach
                    @endif
                  </select>
                </div>
              ...
              <div class="row">
                <div class="col-md-4">
                  <div class="form-group">
                    ...
                    <p>
                      <select name="ODMFO_Year[]" id="Years{{$key}}" class="form-control form-control-sm ddlYears" <?= $work_done_data['Allocated Vendor Code'] != '' ? 'disabled' : $disabled; ?>>
                ...
                <div class="col-md-4">
                  <div class="form-group">
                    ...
                    <p>
                      <input type="text" name="ODMFO_Quantity_Of_Display_Or_Duration[]" id="quantity_duration{{$key}}" placeholder="Enter Quantity of Display or Duration" class="form-control form-control-sm" maxlength="8" onkeypress="return onlyNumberKey(event)" value="{{$work_done_data['Qty Of Display_Duration'] ?? ''}}" <?= $work_done_data['Allocated Vendor Code'] != '' ? 'disabled' : $disabled; ?> step="1">
                    </p>
                  </div>
                </div>
                <div class="col-md-4">
                  <div class="form-group">
                    ...
                    @endphp
                    <p>
                      <input type="text" name="ODMFO_Billing_Amount[]" id="billing_amount{{$key}}" placeholder="Enter Billing Amount(Rs)" class="form-control form-control-sm" onkeypress="return onlyNumberKey(event)" maxlength="8" value="{{$work_done_data1}}" <?= $work_done_data['Allocated Vendor Code'] != '' ? 'disabled' : $disabled; ?>>
                    </p>
                  </div>
                </div>
                <div class="col-md-4">
                  <div class="form-group">
                    ...
                    <div class="input-group">
                      <div class="custom-file">
                        ...
                        <input type="file" name="ODMFO_Upload_Document[]" class="custom-file-doc" data="0" onchange="return uploadFile({{$key}},this)" id="upload_doc_{{$key}}" <?= $work_done_data['Allocated Vendor Code'] != '' ? 'disabled' : $disabled; ?> accept="application/pdf" style="opacity: 0;">
                ...
                @if($work_done_data['Allocated Vendor Code'] == '' && $disabled == '')
                <!-- <div class="row"> -->
                <div class="col-md-6"></div>
                <div class="col-md-2" style="padding: 25px 0 0px 76px; display: {{$key==0 ? 'none' :'block'}}"><button class="btn btn-danger remove_row_next" data="{{$key}}"><i class="fa fa-minus"></i> Remove</button>
            ...
            @endif
            <input type="hidden" value="{{$vendor_data[0]['Allocated Vendor Code']}}" name="allocated_VC">
          ...
          <div id="tab3" class="content content pt-3 tab-pane" role="tabpanel" aria-labelledby="logins-part-trigger">
            ...
            <div class="row" id="neft_div">
              ...
              <div class="col-md-4">
                <div class="form-group">
                  <label for="bank_name">Bank Name / बैंक का नाम<font color="red">*</font></label>
                  <input type="text" name="Bank_Name" id="bank_name" class="form-control form-control-sm" placeholder="Enter Bank Name" maxlength="30" onkeypress="return onlyAlphabets(event)" value="{{$vendor_data[0]['Bank Name'] ?? ''}}" {{ $disabled }}>
                </div>
              </div>
              <div class="col-md-4">
                <div class="form-group">
                  <label for="branch_name">Branch / शाखा<font color="red">*</font></label>
                  <input type="text" name="Bank_Branch" id="branch_name" class="form-control form-control-sm" placeholder="Enter branch" maxlength="30" value="{{$vendor_data[0]['Bank Branch'] ?? ''}}" {{ $disabled }}>
                </div>
              </div>
              <div class="col-md-4">
                <div class="form-group">
              ...
              <div class="col-md-6">
                <div class="form-group">
                  ...
                  <div class="input-group">
                    ...
                    <div class="custom-file">
                      <input type="file" name="Legal_Doc_File_Name_modify" class="custom-file-input" id="Legal_Doc_File_Name_modify" {{$disabled}}>
                      <label class="custom-file-label" id="Legal_Doc_File_Name_modify2" for="Legal_Doc_File_Name_modify">{{ @$vendor_data[0]['Legal Doc File Name'] ? @$vendor_data[0]['Legal Doc File Name'] : 'Choose file' }}</label>
                    </div>
                    <div class="input-group-append">
              ...
              <div class="col-md-6">
                <div class="form-group">
                  ...
                  <div class="input-group">
                    ...
                    <div class="custom-file">
                      <input type="file" name="Attach_Copy_Of_Pan_Number_File_Name_modify" class="custom-file-input" id="Attach_Copy_Of_Pan_Number_File_Name_modify" {{$disabled}}>
              ...
              <div class="col-md-6">
                <div class="form-group">
                  ...
                  <div class="input-group">
                    ...
                    <div class="custom-file">
                      <input type="file" name="Notarized_Copy_File_Name_modify" class="custom-file-input" id="Notarized_Copy_File_Name_modify" {{$disabled}}>
              ...
              <div class="col-md-6"><br><br>
                <div class="form-group">
                  ...
                  <div class="input-group">
                    ...
                    <div class="custom-file">
                      <input type="file" name="Affidavit_File_Name_modify" class="custom-file-input" id="Affidavit_File_Name_modify" {{$disabled}}>
              ...
              <div class="col-md-6">
                <div class="form-group">
                  ...
                  <div class="input-group">
                    ...
                    <div class="custom-file">
                      <input type="file" name="Photo_File_Name_modify" class="custom-file-input" data="0" onchange="return uploadFile(0,this)" id="Photo_File_Name_modify" {{$disabled}}>
              ...
              <div class="col-md-6"><br>
                <div class="form-group">
                  ...
                  <div class="input-group">
                    ...
                    <div class="custom-file">
                      <input type="file" name="GST_File_Name_modify" class="custom-file-input" id="GST_File_Name_modify" {{$disabled}}>
  ...
  function nextSaveData(id) {
    ...
    if ($("#read_only_form").val() == '') {
      ...
      $.ajax({
        ...
        type: 'POST',
        url: "{{Route('personal-renewal-save')}}",
        data: data,
        dataType: "json",
        cache: false,
        contentType: false,
        ...
        success: function(data) {
          ...
          if (data.success == true) {
            ...
            } else if (id == 'next_tab_2') {
              var od_mediaid = $("#vendorid_tab_2").val();
              $('.remove_row_next').each(function(i, obj) {
                var idind = $(this).attr('data');
                $("#line_no_" + idind).val(data.data[i]);
                $("#odmedia_id_" + idind).val(od_mediaid);
