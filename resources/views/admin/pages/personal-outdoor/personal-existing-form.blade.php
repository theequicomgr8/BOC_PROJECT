...
<div class="content-inside p-3">
    <div class="card shadow mb-4">
        ...
        <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
            <h6 class="m-0 font-weight-normal text-primary">Empanelment-Category - A Media(Personal)</h6>
        </div>
        <!-- Card Body -->
    <div class="card-body">
        ...
        <form enctype="multipart/form-data" id="personal_media">
          ...
          <div class="tab-content">
              ...
              <div id="details_of_owner">
                        ...
                        <div class="row" id="authority_details">
                            ...
                            <div class="col-md-4"> <!-- Add -->
                                <div class="form-group">
                                  ...
                                  <input type="text" name="Amount_paid_to_Authority" placeholder="Enter Amount Paid to Authority For The Current Year" class="form-control form-control-sm" id="fax_no4" onkeypress="return onlyNumberKey(event)" value="{{ @$vendor->{'Amount paid to Authority'} != '' ? round($vendor->{'Amount paid to Authority'},2):''}}">
                            ...
                            <!--<div class="col-md-4">
                                <div class="form-group">
                                  ...
                                  <input type="date" name="Media_Type" placeholder="DD/MM/YYYY" class="form-control form-control-sm" min="{{ date('Y-m-d',strtotime('-10 years')) }}" value="{{ (!empty($vendor->{'Duration'}) && @$vendor->{'Duration'} != '1753-01-01 00:00:00.000') ? date('Y-m-d', strtotime(@$vendor->{'Duration'})) : ''}}">
                                </div>
                            </div> -->
                            ...
                            <div class="col-md-4"> <!-- Add -->
                                ...
                                <select name="Rental_Agreement" class="form-control form-control-sm" style="width: 100%;" id="rental_type" >
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <input type="date" name="License_From" id="txt_from" placeholder="DD/MM/YYYY" class="form-control form-control-sm" value="{{ @$vendor->{'License From'} ? date('Y-m-d', strtotime($vendor->{'License From'})) : ''}}">
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <input type="date" name="License_To" id="txt_to" placeholder="DD/MM/YYYY" class="form-control form-control-sm" value="{{ @$vendor->{'License To'} ? date('Y-m-d', strtotime($vendor->{'License To'})) : ''}}">
                                    <span id="date_error" style="color:red;display: none;"></span>
                                </div>
                            </div>
                        </div><br>
                ...
                <div class="row col-md-12">
                  <h4 class="subheading">Details of work in last six months, for the applied media only, if any (As per format given below)<br>
                    केवल लागू मीडिया के लिए पिछले छह महीनों में कार्य का विवरण, यदि कोई हो (नीचे दिए गए प्रारूप के अनुसार)
                    :-</h4>
                </div>
                <br>
                <div class="row">
                ...
                <div class="row" id="xls_show2" style="display: none;">
                  <div class="col-md-4">
                    <input type="file" name="media_import2" id="media_address_import2" class="form-control form-control-sm" accept=".csv, application/vnd.openxmlformats-officedocument.spreadsheetml.sheet, application/vnd.ms-excel">
                  </div>
                </div>
                  ...
                  <div class="row">
                    ...
                    <div class="col-md-4">
                      <div class="form-group">
                        ...
                        <p>
                          <input type="date" name="from_date[]" id="from_date" class="form-control form-control-sm" value="{{ (!empty(@$works->{'From Date'}) && @$works->{'From Date'} != '1753-01-01 00:00:00.000') ? date('Y-m-d', strtotime(@$works->{'From Date'})) : ''}}">
                        </p>
                      </div>
                    </div>
                    <div class="col-md-4">
                      <div class="form-group">
                        ...
                        <p>
                          <input type="date" name="to_date[]" id="to_date" class="form-control form-control-sm" value="{{ (!empty(@$works->{'To Date'}) && @$works->{'To Date'} != '1753-01-01 00:00:00.000') ? date('Y-m-d', strtotime(@$works->{'To Date'})) : ''}}">
                        </p>
                      </div>
                    </div>
            ...
            <a class="btn btn-primary set-pm-next-button" id="tab_1">Save <i class="fa fa-arrow-circle-right fa-lg"></i>
            </a>
          </div>
          </div>
    </form>
...
@section('custom_js')
<script src="{{ url('/js') }}/perosnal_existing_validation.js"></script>
<script src="{{ url('/js') }}/personal-common.js"></script>
...
<script>
    ...
    //                     i +
    //                     '"><option value="">Select Sub-Category</option></select></p></div></div><div class="col-md-6"></div><div class="col-md-2" style="padding: 2% 0 0 88%;"><button class="btn btn-danger remove_row"><i class="fa fa-minus"></i> Remove</button></div></div>'
    //                 );
    //             }
    //         });
    //         $("#count_id").val(i);
