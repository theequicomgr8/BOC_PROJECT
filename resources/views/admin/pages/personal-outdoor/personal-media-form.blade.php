...
<div class="content-inside p-3">
  <div class="card shadow mb-4">
    ...
    <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
      <h4 class="m-0 font-weight-normal text-primary">Empanelment-Category - A Media(Personal)</h4>
    </div>
    <!-- Card Body -->
    <div class="card-body">
            ...
            <div class="row">
              <div class="col-md-4">
                <div class="form-group">
                  ...
                  <input type="text" class="form-control form-control-sm" name="GST_No" id="GST_No" placeholder="Enter GST No." onkeypress="return isAlphaNumeric(event)" onchange="return checksum(this.value)" maxlength="15" value="{{$vendor_data[0]['GST No_']?? $gst_value}}" {{$read}} tabindex="{{$tab}}" style="pointer-events: {{$pointer}};">
              ...
              <div class="col-md-4">
                <div class="form-group">
                  ...
                  <select name="Rental_Agreement" class="form-control form-control-sm {{ $click }}" style="width: 100%; pointer-events: {{$pointer}};" id="rental_type" {{$read}} tabindex="{{$tab}}" >
                    ...
                    @foreach($arr as $key =>$value)   <!-- !empty( @$vendor_data[0]['Rental Agreement'] ) && @$vendor_data[0]['Rental Agreement']==$key -->
            ...
            <div class="row">
              <div class="col-md-4">
                  @if(@$vendor_data[0]['File Name']=="")
                      <div class="form-group">
                          <label for="exampleInputFile">Upload Document / दस्तावेज़ अपलोड करें {{ @$vendor_data[0]['File Name'] }}<font color="red">*</font></label>
