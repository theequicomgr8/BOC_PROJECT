...
<div class="content-inside p-3">
  ...
  <div class="card shadow mb-4">
    ...
    <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
      <h6 class="m-0 text-primary"><i class="fa fa-edit"></i>Application for Advertisement</h6>
      @if($disabled=='disabled')
      <p><a href="{{url('GeneratePDFclientReq/'.@$crh->{'Client Request No'})}}" class="m-0 font-weight-normal text-primary"> <i class="fa fa-download"></i> Media request application receipt</a></p>@endif
    </div>
    <!-- Card Body -->
    <div class="card-body">
      ...
      <ul class="nav nav-tabs" id="myTab" role="tablist">
        <li class="tab-nav-item" id="BasicInformation">
          <a class="nav-link mediatab active" id="#BasicInformation-tab" data-toggle="tab" role="tab" aria-controls="BasicInformation" aria-selected="BasicInformation">Basic Information</a>
        </li>

      </ul>

      <form method="POST" class="client_request" id="client_request" enctype="multipart/form-data">
        @csrf
        <div class="tab-content">
          <div class="tab-pane content pt-3 mcontenttab show active" id="BasicInformation-tab" role="tabpanel" aria-labelledby="BasicInformation-tab">
            <div class="row">
              <!-- <div class="col-md-4">
                <div class="form-group">
                  <label class="form-control-label">Ministry Code/मंत्रालय कोड</label>
                  <input {{ $disabled }} type="text" class="form-control form-control-sm" id="Ministry_Code" name="Ministry_Code" placeholder="Enter Ministry Code" onkeypress="return onlyAlphabets(event,this)" maxlength="20" readonly value="{{@$mhead->{'New Ministry Code'} ?? ''}}">
              ...
              <!-- <div class="col-md-4">
                <div class="form-group">
                  <label class="form-control-label">Department Code/विभाग कोड</label>
                  <input {{ $disabled }} type="text" class="form-control form-control-sm" id="Department_Code" name="Department_Code" placeholder="Enter Department Code" onkeypress="return onlyNumberKey(event)" maxlength="10" readonly value="{{@$mhead->{'Department'} ?? ''}}">
            ...
            <div class="row">
              ...
              <div class="col-md-4">
                <div class="form-group">
                  <label class="form-control-label">Officer Name/अधिकारी का नाम</label>
              ...
              <div class="col-md-4">
                <div class="form-group">
                  <label class="form-control-label">Designation/पद</label>
            ...
            <div class="row">
              <div class="col-md-4">
                <div class="form-group">
                  <label class="form-control-label">E-mail ID/ई मेल आईडी</label>
              ...
              <div class="col-md-4">
                <div class="form-group">
                  <label class="form-control-label">Mobile No./मोबाइल नंबर</label>
                  <input {{ $disabled  }} type="text" class="form-control form-control-sm" name="mobile" placeholder="Enter Mobile No." onkeypress="return onlyNumberKey(event)" maxlength="10" value="{{ session()->get('Mobile') }}" readonly>
                </div>
              </div>
            ...
            <div class="row">
              <div class="col-md-4">
                <div class="form-group">
                  ...
                  <input {{ $disabled }} type="text" class="form-control form-control-sm" name="phone" placeholder="Enter Phone No." onkeypress="return onlyNumberKey(event)"  minlength="12" maxlength="12" value="{{$crh->{'Phone No_'} ??''}}">
                </div>
              </div>
              <div class="col-md-4">
                <div class="form-group">
                  <label class="form-control-label">Address/पता</label>
                  <textarea readonly {{ $disabled }} name="address" id="address" placeholder="Enter Address" rows="2" cols="50" minlength="2" maxlength="120" class="form-control form-control-sm">{{session()->get('profile_address')}}</textarea>
             ...
             <!--  <div class="col-md-4">
                <div class="form-group">
                  ...
                  <input {{ $disabled }} style="{{$style}}" type="text" class="form-control form-control-sm" name="from_date" id="from_date" value="{{$fromDate}}" placeholder="DD/MM/YYYY" autocomplete="off">
            ...
            <div class="row">
             <!--  <div class="col-md-4">
                <div class="form-group">
                  ...
                  <input {{ $disabled }} style={{ $style }} type="text" class="form-control form-control-sm" name="to_date" id="to_date" value="{{$toDate}}" placeholder="DD/MM/YYYY" autocomplete="off">
                  <span id="date_error" style="color:red;display: none;"></span>
                </div>
              </div> -->
              <!-- <div class="col-md-4">
                <div class="form-group">
                  ...
                  <input {{ $disabled }} type="text" class="form-control form-control-sm" name="tentative_budget" maxlength="20" id="tentative_budget" placeholder="Enter Tentative Budget." onkeypress="return onlyNumberKey(event)" value="{{ round(@$crh->{'Overall Budget'}) && round(@$crh->{'Overall Budget'})!=0? round(@$crh->{'Overall Budget'}):'' }}">
                </div>
              </div> -->
               <div class="col-md-4">
                <div class="form-group">
                  <label class="form-control-label"> Campaign/Add Theme/अभियान/थीम जोड़ें</label>
                  <input {{ $disabled }} name="subject" id="subject" placeholder="Enter Campaign/Theme " class="form-control form-control-sm" minlength="2" maxlength="40"  value="{{ $crh->{'Subject'} ?? '' }}">
                </div>
              </div>
              <div class="col-md-4">
                <div class="form-group">
          ...
          <div class="tab-pane content pt-3 mcontenttab" value="{{$mtab['mdNameVal']}}" id="{{@$mtab['mdName'] }}-tab" role="tabpanel" aria-labelledby="{{@$mtab['mdName'] }}-tab">
          ...
          <div class="row">
            <div class="col-sm-12 text-right">
              <a class="btn btn-primary reg-previous-button  btn-sm m-0" id="previous_btn" onclick="btnprev()"><i class="fa fa-caret-left"></i>Previous</a>
              <a class="btn btn-primary client-next-button btn-sm m-0 loader " id="btntab" onclick="btnSubmit()"> </a>
              <span class="basictab" id="dynamictabname"></span>
...
<script>
  //multi select for media category on add more case
  $('#outdoorMediaCategory0').multiselect({
    nonSelectedText: 'Select Media Category',
...
<script type="text/javascript">
  //for print media localization 
  $( "#from_date" ).datepicker( "option", $.datepicker.regional[ 'fr' ] );
  $( "#to_date" ).datepicker( "option", $.datepicker.regional[ 'fr' ] );

  $( "#outdoorfrom_date" ).datepicker( "option", $.datepicker.regional[ 'fr' ] );
  $( "#outdoorto_date" ).datepicker( "option", $.datepicker.regional[ 'fr' ] );

  $( "#tvfrom_date" ).datepicker( "option", $.datepicker.regional[ 'fr' ] );
  $( "#tvto_date" ).datepicker( "option", $.datepicker.regional[ 'fr' ] );

  $( "#crsRadiofrom_date" ).datepicker( "option", $.datepicker.regional[ 'fr' ] );
  $( "#crsRadioto_date" ).datepicker( "option", $.datepicker.regional[ 'fr' ] );
...
<script type="text/javascript">
  ...
  $("#addRow").click(function() {
    ...
    ++i;
    ++j;
    odcatid='outdoorMediaCategory'+i;
   ...
   /*html += '<h6 class="m-0 text-primary"><i class="fa fa-edit"></i> Media Details</h6>';*/
    ...
    html += '<div class="col-md-4"><div class="form-group"><label class="form-control-label">Media Category/ मीडिया श्रेणी<span style="color:red">*</span><br></label><select  name="outdoorMediaCategory[' + i + '][]" id="outdoorMediaCategory' + i + '" class="form-control form-control-sm" multiple><option value="0" >Airport </option><option value="1" >Railways</option><option value="2" > Road Side </option><option value="3" >Transit Media </option> <option value="4">Others </option><option value="5" >Metro</option><option value="6" >Bus & Station</option>></select></div></div>';
   ...
   /* html += '<div class="col-md-4"><div class="form-group"><label class="form-control-label">Media subcategory/मीडिया उपश्रेणी</label><select  name="outdoorMediaSubCategory[]" id="outdoorMediaSubCategory' + i + '" class="form-control form-control-sm"><option >Select media subcategory</option></select></div></div>';*/
    ...
    $('#newRow').append(html);
    //for media vategory multi select list
     multiselectVar= $("#"+odcatid).multiselect({
      nonSelectedText: 'Select Media Category',
      enableFiltering: true,
      enableCaseInsensitiveFiltering: true,
      buttonWidth:'100%',
