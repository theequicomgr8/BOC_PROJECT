  ...
  <div class="card shadow mb-4">
    ...
    <div class="card-body">
      <div class="card-body p-2">
        <form name ="odmsearch" id="odmsearch" method="GET" enctype="multipart/form-data" action="{{Route('ODMediaPlan.index')}}" >
          <div class="row">
            <div class="col-md-4">
              <div class="form-group">
                ...
                <option value="0" {{ $odmediaType == "0" ? "selected" :""}}>Sole Right</option>
                <option value="1" {{ $odmediaType == "1" ? "selected" :""}}>Personal Media(PMC)</option>
                <option value="2" {{ $odmediaType == "2" ? "selected" :""}}>Private Media</option>
              </select>
              </div>
            </div>
            <div class="col-md-2">
        ...
        <table class="table table-striped table-bordered table-hover order-list" id="myTable">    
          ...
          <tbody>
            ...
            <tr>
              ...
              <td>{{ $result->{'MP No_'} }} </td>
              <td>{{ $result->{'Client Request No_'}  }} </td>
              ...
              <td><a class="m-0 font-weight-normal text-primary" href="{{route('ODMediaPlan.show', $result->{'MP No_'} )}}"  style="font-size:15px;"   class="editMember" >View</a> </td>
