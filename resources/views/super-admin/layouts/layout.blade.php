 ...
 <head>
  ...
  <title>Central Bureau of Communication | CBC </title>
...
<body>
  <div id="app" >
   ...
   <div id="wrap" class="animsition backlayer" style="opacity: 1;background:url({{asset('super-admin/banner.jpg')}})">
    <header class="layerLeft">
      <div class="logo"><a href=""><img alt="" src="{{URL::to('theme/images/logo.png')}}" title=""></a></div>
      <!-- <marquee><font color="red">NOTE: Today is the last day to complete your application form. Please submit your online application form before 12:00 mid night.</font></marquee>  -->
    </header>
  </div>
  <main class="py-4">
    @yield('content')
