...
<div class="content-wrapper">
    ...
    <div class="content-header">
      ...
      <h6 class="m-0 text-primary"><i class="fa fa-edit"></i> FO TTP List </h6> 
    </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-xl-2">
                                <div class="form-group">
                                    ...
                                    <select name="approve" id="approve_data" class="form-control form-control-sm">
                            ...
                            <div class="col-xl-1">
                                <div class="form-group">
                                    ...
                                    <span class="btn btn-info btn-sm" id="search" style="cursor: pointer; margin-top:6px;">View</span>
                                </div>
                            </div>
