                        ...
                        <tbody id="tbody">
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    <a href="{{URL::to('pre-active-form/'.$item->Pk_id)}}" style="text-decoration: none;color: blue;" id="view">View</a>
                                </td>
                                <td> 
                                    @if($item->duration_activity_to_date < date('Y-m-d') && $item->approve==1)
                                        @if($item->status==2)
                                        <a href="{{URL::to('post-form/'.$item->Pk_id)}}" style="text-decoration: none;color: green;" id="view">Submited</a>
                                        @else
                                        {{'NA'}}
                                        @endif
                                    @else 
