                  ...
                  <table class="table table-bordered">
                    ...
                    <tbody>
                      ...
                      <tr>
                        <td> 6 </td>
                        <td>
                          <span id="GridView2_ctl24_lbl_main_event_activity">DISTRIBUTION OF GOVT BENEFITS <br><span style="cursor: pointer;color: blue;" id="distrubution">More..</span></span>
                        </td>
                        <td valign="middle">
                          ...
                          <span id="GridView2_ctl24_lbl_main_event_desc">DISTRIBUTION OF UJWALA GAS CONNECTIONS</span>
                        </td>
                        @php
                        ...
                        <td valign="middle">
                          <textarea maxlength="120" name="ujwala_gas_main_remark" rows="2" cols="20" id="GridView2_ctl24_txt_main_remarl" {{$ujwala_gas}} style="height:50px;" class="form-control" {{$block}}>{{@$data->ujwala_gas_main_remark ?? ''}}</textarea>
                        </td>
                      </tr>
                      <tr id="distrubution2">
                        <td></td>
                        ...
                        <td valign="middle">
                          <textarea maxlength="120" name="mudra_loans_main_remark" rows="2" cols="20" id="GridView2_ctl25_txt_main_remarl" {{$mudra_loans}} style="height:50px;" class="form-control" {{$block}}>{{@$data->mudra_loans_main_remark ?? ''}}</textarea>
                        </td>
                      </tr>
                      <tr id="distrubution3">
                        <td></td>
                        ...
                        <td valign="middle">
                          <textarea maxlength="120" name="kisian_credits_card_main_remark" rows="2" cols="20" id="GridView2_ctl26_txt_main_remarl" {{$kisian_credits}} style="height:50px;" class="form-control" {{$block}}>{{@$data->kisian_credits_card_main_remark ?? ''}}</textarea>
                        </td>
                      </tr>
                      <tr id="distrubution4">
                        <td>  </td>
                        ...
                        <td valign="middle">
                          <textarea maxlength="120" name="opening_account_main_remark" rows="2" cols="20" id="GridView2_ctl27_txt_main_remarl" {{$opening_account}} style="height:50px;" class="form-control" {{$block}}>{{@$data->opening_account_main_remark ?? ''}}</textarea>
                        </td>
                      </tr>
                      <tr id="distrubution5">
                        <td></td>
                        ...
                        <td valign="middle">
                          <textarea maxlength="120" name="other_govt_scheme_main_remark" rows="2" cols="20" id="GridView2_ctl28_txt_main_remarl" {{$other_gov}} style="height:50px;" class="form-control" {{$block}}>{{@$data->other_govt_scheme_main_remark ?? ''}}</textarea>
                        </td>
                      </tr>

                      <tr id="distrubution6"><!-- add new field -->
                        <td></td>
                        <td>
                          <span id="GridView2_ctl28_lbl_main_event_activity"></span>
                        </td>
                        ...
                        <td valign="middle">
                          <textarea maxlength="120" name="govt_other_remark" rows="2" cols="20" id="govt_other_remark" {{$govt_othe}} style="height:50px;" class="form-control" {{$block}}>{{@$data->govt_other_remark ?? ''}}</textarea>
                        </td>
                      </tr>
                      <!--  add 2022 7 apr -->
                      <tr>
