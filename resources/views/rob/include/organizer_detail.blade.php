          ...
          <div class="row">
            ...
            <div class="col-xl-4">
              <div class="form-group">
                ...
                <input type="text" name="person_designation" value="{{@$data->person_designation ?? ''}}" id="person_designation" onkeypress="return alphaOnly(event)" maxlength="50" class="form-control form-control-sm" {{$block}} {{$mouse}}>
            ...
            <div class="col-xl-4">
              <div class="form-group">
                ...
                <input type="text" name="contact_no" value="{{@$data->contact_no ?? ''}}" id="contact_no" onkeypress="return onlyNumberKey(event)" maxlength="10" minlength="10"  class="form-control form-control-sm" {{$block}} {{$mouse}}>
                <span id="vip_designation_err_" style="color: red;"></span>
              </div>
            </div>
