...
//test
    ...
    public function pre_insert(Request $request)
    {
            ...
            if(Session::get('UserType')==2)
            {
                ...
                else
                {
                    ...
                    $first_code=substr($unique_id,0,11);
                    // dd($unique_id);
    ...
    public function robSearch(Request $request)
    {
        ...
        foreach ($data as $key => $item) 
        {
            ...
            $html.="<td>".$item->last_visit_date."</td>";
            $html.="<td>".$item->contact_no."</td>";
            $html.="<td>".$item->sop_theme."</td>";
            $html.="<td>".'<a href="pre-active-form/'.$item->Pk_id.'" style="text-decoration: none;color: blue;" id="view"><i class="fa fa-eye" style="font-size:20px;color:blue"></i></a>'."</td>";
            $html.="</tr>";
        }
        echo $html;
    }
    ...
    public function robcreate($user_name)
    {
        ...
        $data=DB::table('BOC$UMM User$3f88596c-e20d-438c-a694-309eb14559b2')->select('User Name')->where('User Name',$user_name)->first();
